      ...
      <div className="flex items-start gap-2 min-w-0">
        {onBack && (
          <button
            ...
            className="shrink-0 w-8 h-8 -ml-1 grid place-items-center rounded-full border border-white/10 bg-black/40 backdrop-blur hover:border-white/30 hover:bg-black/60 active:scale-95 transition"
          >
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-purple-500 to-purple-800 grid place-items-center shadow-[0_0_24px_-4px_rgba(126,58,142,0.7)] border border-amber-400/40 shrink-0">
              ...
              return (
                <div key={p.deviceId} className="flex flex-col items-center gap-1 min-w-[60px]">
                  <div className="relative" style={{ overflow: "visible" }}>
                    ...
                    {isHostP && (
                      <div className="absolute -top-1 -right-1 text-[10px] bg-amber-400 text-black rounded-full w-4 h-4 grid place-items-center font-bold border border-[var(--bg)] z-10">★</div>
                    )}
                  </div>
      ...
      <div className="relative">
        ...
        <div className="px-6 relative z-10">
          <h1 className="text-[26px] leading-[1.05] font-semibold tracking-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
            ...
            {step === "songs" && currentPlayer && <>Hey, <span className="text-amber-400">{currentPlayer.name}</span>.</>}
          ...
          <div className="mt-5 px-6 relative z-10">
            ...
            <div className="flex flex-wrap gap-2">
              {state.players.map(p => {
                ...
                return (
                  <div key={p.deviceId} className="flex items-center gap-2 rounded-full px-2.5 py-1 bg-black/40 border border-white/10">
        ...
        {step === "intro" && (
          <div className="mt-6 px-6 relative z-10">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-[10px] uppercase tracking-[0.22em] text-amber-200/90">Begin</div>
            ...
            <div className="mt-4 mx-6 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl p-4 space-y-3 grain relative z-10">
              ...
              <button
                ...
                className={cx(
                  ...
                  loading
                    ? "bg-purple-700/60 text-white/70 cursor-wait border-purple-700/40"
                    : "bg-gradient-to-b from-purple-600 to-purple-800 hover:brightness-110 border-amber-400/40 shadow-[0_10px_28px_-10px_rgba(126,58,142,0.9)]"
                )}
              >
                {loading && (
                  <svg className="animate-spin" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
        ...
        {/* ---- PASS SCREEN ---- */}
        {step === "pass" && (
          <div className="mt-6 mx-6 rounded-2xl border border-white/10 bg-black/50 backdrop-blur-xl p-5 grain relative z-10 text-center">
            <div className="text-6xl mb-2">🤝</div>
            <div className="text-sm text-white/65 mb-4">Hand the phone to the next player.</div>
            <button
              onClick={startNextPlayer}
              className="w-full rounded-xl py-3 text-sm font-semibold border bg-gradient-to-b from-purple-600 to-purple-800 hover:brightness-110 shadow-[0_10px_28px_-10px_rgba(126,58,142,0.9)] border-amber-400/40"
            >
              I'm the next player →
            </button>
          </div>
        ...
        <div className="px-6 pt-6 pb-10 relative z-10">
          <button
            ...
            className={cx(
              "w-full rounded-xl py-4 text-base font-semibold transition",
              canStart
                ? "bg-gradient-to-b from-amber-500 to-amber-700 hover:brightness-110 shadow-[0_14px_36px_-12px_rgba(212,168,67,0.7)] border border-amber-300/40 text-black"
                : "bg-white/[0.04] text-white/30 border border-white/5"
            )}
          >
            {canStart
                  ...
                  className={cx(
                    ...
                    active
                      ...
                      : locked
                        ...
                        : "bg-black/30 border-white/10 text-white/75 hover:border-white/30"
                  )}
                >
          ...
          <div className="mt-4 rounded-2xl border border-white/10 bg-black/30 backdrop-blur-md p-3 min-h-[180px]">
            {!activePlayer ? (
              ...
              <div className="text-center py-8 px-4">
                ...
                <div className="text-sm text-amber-300/90 font-medium">This one's yours, {activePlayer.name}.</div>
                <div className="text-[12px] text-white/50 mt-1">No guess for you. Hand the phone to someone else.</div>
              </div>
            ) : activeGuess ? (
              <div className="text-center py-6">
                <div className="text-[11px] uppercase tracking-[0.16em] text-emerald-300/80 mb-2">
              ...
              <>
                <div className="px-2 py-1 text-[11px] uppercase tracking-[0.16em] text-white/40">
                  <span className="text-amber-300">{activePlayer.name}</span>, who do you suspect?
                </div>
